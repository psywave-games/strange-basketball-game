  ...
  if(ds_exists(argument[0], ds_type_map)){
    ...
    if(ui_get_type(argument[0]) == ui_type_button or ui_get_type(argument[0]) == ui_type_textbox or ui_get_type(argument[0]) == ui_type_select){
      ...
      if(ui_get_type(argument[0]) == ui_type_button){
        if(ui_width == ui_default) ui_width = string_width(string_hash_to_newline(ui_text));
        if(ui_height == ui_default) ui_height = string_height(string_hash_to_newline(ui_text));
      }
      else if(ui_get_type(argument[0]) == ui_type_select){
        if(ui_width == ui_default) ui_width = 320;
        if(ui_height == ui_default) ui_height = string_height(string_hash_to_newline("|"));
        var ui_items = ds_map_find_value(argument[0], "ui_items");
      ...
      return ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_size && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_size) or (ui_mouse_x > ui_x + ui_size && ui_mouse_x < ui_x + ui_size + ui_padding_horizontal + string_width(string_hash_to_newline(ui_label)) && ui_mouse_y > ui_y + ((ui_size * 0.5) - (string_height(string_hash_to_newline(ui_label)) * 0.5))&& ui_mouse_y < ui_y + ((ui_size * 0.5) + (string_height(string_hash_to_newline(ui_label)) * 0.5))));
    }
      ...
      return ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_width && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_height) or (ui_mouse_x > ui_x + ui_width && ui_mouse_x < ui_x + ui_width + ui_padding_horizontal + string_width(string_hash_to_newline(ui_label)) && ui_mouse_y > ui_y + ((ui_height * 0.5) - (string_height(string_hash_to_newline(ui_label)) * 0.5))&& ui_mouse_y < ui_y + ((ui_height * 0.5) + (string_height(string_hash_to_newline(ui_label)) * 0.5))));
    }
    else if(ui_get_type(argument[0]) == ui_type_tab){
      var ui_x = ds_map_find_value(argument[0], "ui_x");
      var ui_y = ds_map_find_value(argument[0], "ui_y");
      ...
      if(ui_height == ui_default) ui_height = string_height(string_hash_to_newline("|")) + 16;
  ...
  if(ds_exists(argument[0], ds_type_map)){
    ...
    if(ui_type == ui_type_button){
      ...
      if(ui_enable){
        ...
        if(ui_shadow) draw_text_colour(ui_x + (ui_width * 0.5) + ui_padding_horizontal, ui_y + (ui_height * 0.5) + ui_padding_vertical + 1, string_hash_to_newline(ui_text), ui_black, ui_black, ui_black, ui_black, 0.05);
        draw_text_colour(ui_x + (ui_width * 0.5) + ui_padding_horizontal, ui_y + (ui_height * 0.5) + ui_padding_vertical , string_hash_to_newline(ui_text), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        ...
        draw_set_halign(fa_center);
        draw_set_valign(fa_middle);
        draw_text_colour(ui_x + (ui_width * 0.5) + ui_padding_horizontal, ui_y + (ui_height * 0.5) + ui_padding_vertical , string_hash_to_newline(ui_text), ui_grey, ui_grey, ui_grey, ui_grey, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
      if(ui_focus){
...
if(argument_count == 1){
  if(ds_exists(argument[0], ds_type_map)){
    ...
    if(ui_type == ui_type_textbox){
      ...
      if(ui_width == ui_default) ui_width = 320;
      if(ui_height == ui_default) ui_height = string_height(string_hash_to_newline("|"));
      if(string_width(string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#"))) > ui_width){
        while(string_width(string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#"))) > ui_width){
      ...
      if(ui_enable){
            ...
            if(device_mouse_check_button_pressed(0, mb_left)){
              ...
              if(ui_password){
                ...
                if(ui_text == ""){ui_beam_position = 0;}
                  ...
                  ui_beam_position = max(0, round((min(ui_mouse_x, ui_x + ui_padding_horizontal + string_width(string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#")))) - (ui_x + ui_padding_horizontal)) / string_width(string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#"))) * string_length(ui_alias_text)) + (string_pos(ui_alias_text, ui_text) - 1));
                }
                ds_map_replace(argument[0], "ui_beam_position", ui_beam_position);
              }
            }
        ...
        if(ui_text != ""){
          ui_label_top = string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical;
        ...
        if(ui_focus){
          ...
          if(!ui_readonly){
            if(ui_text == ""){
              if(ui_effect){
                if(ui_label_top < (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical)){
                  ui_label_top += ui_effect_speed;
                  ui_label_top = min(ui_label_top, (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical));
                  ds_map_replace(argument[0], "ui_label_top", ui_label_top);
                }
              }
              else{ds_map_replace(argument[0], "ui_label_top", string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical);}
            }
              ...
              if((keyboard_key == vk_left) && !ui_password){
                if(ui_beam_position > 0){
                  if(ui_beam_position < string_pos(ui_alias_text, ui_text)){
                    ...
                    if(string_width(string_hash_to_newline(ui_temp)) > ui_width){
                      while(string_width(string_hash_to_newline(ui_temp)) > ui_width){
        ...
        if(ui_text = ""){
          if(ui_effect){
            var ui_col_r = lerp(colour_get_red(ui_background_colour), colour_get_red(ui_foreground_colour), 1 - (ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical)));
            var ui_col_g = lerp(colour_get_green(ui_background_colour), colour_get_green(ui_foreground_colour), 1 - (ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical)));
            var ui_col_b = lerp(colour_get_blue(ui_background_colour), colour_get_blue(ui_foreground_colour), 1 - (ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical)));
            ui_background_colour = make_colour_rgb(ui_col_r, ui_col_g, ui_col_b);
          }
          else{
            if(ui_label_top < (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical)){ui_background_colour = ui_foreground_colour;}
          }
        }
        if(ui_shadow){
          draw_set_alpha(ui_alpha);
        ...
        if(ui_password){
          ...
          for(ui_i = 0; ui_i < ui_password_length; ui_i += 1){
            draw_set_alpha(0.05);
            draw_circle_colour(ui_x + ui_padding_horizontal + 2 + (ui_i * 12), ui_y + ui_padding_vertical + ((string_height(string_hash_to_newline("|")) * 0.5)) + 1, 4, ui_black, ui_black, false);
            draw_set_alpha(1);
            draw_circle_colour(ui_x + ui_padding_horizontal + 2 + (ui_i * 12), ui_y + ui_padding_vertical + ((string_height(string_hash_to_newline("|")) * 0.5)), 4, ui_foreground_colour, ui_foreground_colour, false);
          }
          if(ui_focus){
            if(ui_beam < room_speed * 0.5){
              draw_set_alpha(0.05);
              draw_line_width_colour(ui_x + ui_padding_horizontal + (ui_password_length * 12), ui_y + ui_padding_vertical + 1, ui_x + ui_padding_horizontal + (ui_password_length * 12), ui_y + ui_padding_vertical + string_height(string_hash_to_newline("|")) + 1, 1, ui_black, ui_black);
              draw_set_alpha(1);
              draw_line_width_colour(ui_x + ui_padding_horizontal + (ui_password_length * 12), ui_y + ui_padding_vertical, ui_x + ui_padding_horizontal + (ui_password_length * 12), ui_y + ui_padding_vertical + string_height(string_hash_to_newline("|")), 1, ui_foreground_colour, ui_foreground_colour);
            }
          }
        }
        else{
          draw_set_halign(fa_left);
          draw_set_valign(fa_top);
          if(ui_shadow) draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical + 1, string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#")), ui_black, ui_black, ui_black, ui_black, 0.05);
          draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical, string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#")), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
          if(ui_focus){
            if(ui_beam < room_speed * 0.5){
              if(ui_shadow){
                draw_set_alpha(0.05);
                draw_line_width_colour(ui_x + ui_padding_horizontal + string_width(string_hash_to_newline(string_replace_all(string_copy(ui_alias_text, 1, ui_beam_position - (string_pos(ui_alias_text, ui_text) - 1)), "#", "\\#"))) + 1, ui_y + ui_padding_vertical, ui_x + ui_padding_horizontal + string_width(string_hash_to_newline(string_replace_all(string_copy(ui_alias_text, 1, ui_beam_position - (string_pos(ui_alias_text, ui_text) - 1)), "#", "\\#"))) + 1, ui_y + ui_padding_vertical + string_height(string_hash_to_newline("|")) + 1, 1, ui_black, ui_black);
                draw_set_alpha(1);
              }
              draw_line_width_colour(ui_x + ui_padding_horizontal + string_width(string_hash_to_newline(string_replace_all(string_copy(ui_alias_text, 1, ui_beam_position - (string_pos(ui_alias_text, ui_text) - 1)), "#", "\\#"))) + 1, ui_y + ui_padding_vertical, ui_x + ui_padding_horizontal + string_width(string_hash_to_newline(string_replace_all(string_copy(ui_alias_text, 1, ui_beam_position - (string_pos(ui_alias_text, ui_text) - 1)), "#", "\\#"))) + 1, ui_y + ui_padding_vertical + string_height(string_hash_to_newline("|")), 1, ui_foreground_colour, ui_foreground_colour);
            }
          }
        }
        if(font_exists(ui_label_font)){draw_set_font(ui_label_font);}
        draw_text_transformed_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical - ui_label_top, string_hash_to_newline(ui_label), max(1 - ui_label_top / ((string_height(string_hash_to_newline("|")) * 0.85) + ui_padding_vertical), 0.85), max(1 - ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85), 0.85), 0, ui_background_colour, ui_background_colour, ui_background_colour, ui_background_colour, 1);
      }
      else{
        if(ui_text != ""){
          ui_label_top = string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical;
        ...
        if(ui_password){
          var ui_password_length = string_length(ui_alias_text);
          if(string_length(ui_alias_text) > floor(ui_width / 12)){ui_password_length = floor(ui_width / 12);}
          for(ui_i = 0; ui_i < ui_password_length; ui_i += 1){draw_circle_colour(ui_x + ui_padding_horizontal + 2 + (ui_i * 12), ui_y + ui_padding_vertical + ((string_height(string_hash_to_newline("|")) * 0.5)), 4, ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), false);}
        }
        else{
          if(font_exists(ui_font)){draw_set_font(ui_font);}
          draw_set_halign(fa_left);
          draw_set_valign(fa_top);
          draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical, string_hash_to_newline(string_replace_all(ui_alias_text, "#", "\\#")), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), 1);
        }
        if(font_exists(ui_label_font)){draw_set_font(ui_label_font);}
        draw_text_transformed_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical - ui_label_top, string_hash_to_newline(ui_label), max(1 - ui_label_top / ((string_height(string_hash_to_newline("|")) * 0.85) + ui_padding_vertical), 0.85), max(1 - ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85), 0.85), 0, ui_grey, ui_grey, ui_grey, ui_grey, 1);
      }
      if(ui_focus){
        if(ds_exists(ui_global_config, ds_type_map)){
          if(ds_map_find_value(ui_global_config, "debug_mode")){
  ...
  if(ds_exists(argument[0], ds_type_map)){ 
    ...
    if(ui_type == ui_type_checkbox){ 
      ...
      if(ui_enable){
        ...
        if(ui_active && ((ui_mouse_x > ui_x + ui_padding_horizontal && ui_mouse_x < ui_x + ui_padding_horizontal + ui_size && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_padding_horizontal + ui_size) or (ui_mouse_x > ui_x + ui_padding_horizontal + ui_size && ui_mouse_x < ui_x + ui_size + (ui_padding_horizontal * 2) + string_width(string_hash_to_newline(ui_label)) && ui_mouse_y > ui_y + ui_padding_horizontal + ((ui_size * 0.5) - (string_height(string_hash_to_newline(ui_label)) * 0.5))&& ui_mouse_y < ui_y + ui_padding_horizontal + ((ui_size * 0.5) + (string_height(string_hash_to_newline(ui_label)) * 0.5))) or (ui_focus && keyboard_action && keyboard_check_pressed(vk_enter)))){
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        if(ui_shadow) draw_text_colour(ui_x + ui_padding_horizontal + ui_size + ui_padding_horizontal, ui_y + ui_padding_horizontal +(ui_size * 0.5) + 1, string_hash_to_newline(ui_label), ui_black, ui_black, ui_black, ui_black, 0.05);
        draw_text_colour(ui_x + ui_padding_horizontal + ui_size + ui_padding_horizontal, ui_y + ui_padding_horizontal +(ui_size * 0.5), string_hash_to_newline(ui_label), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
      else{
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        draw_text_colour(ui_x + ui_padding_horizontal + ui_size + ui_padding_horizontal, ui_y + ui_padding_horizontal +(ui_size * 0.5), string_hash_to_newline(ui_label), ui_grey, ui_grey, ui_grey, ui_grey, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top); 
      }
      if(ui_focus){
        if(ds_exists(ui_global_config, ds_type_map)){
          if(ds_map_find_value(ui_global_config, "debug_mode")){
            draw_set_alpha(0.25);
            draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_size + (ui_padding_horizontal * 3) + string_width(string_hash_to_newline(ui_label)) + 2, ui_y + ui_size + (ui_padding_horizontal * 2)+ 2, ui_blue_grey, ui_blue_grey, ui_blue_grey, ui_blue_grey, true);
            draw_set_alpha(1);
          }
        }
      }
  ...
  if(ds_exists(argument[0], ds_type_map)){  
    ...
    if(ui_type == ui_type_radio){ 
      ...
      if(ui_enable){
        ...
        if(ui_active && ((ui_mouse_x > ui_x + ui_padding_horizontal && ui_mouse_x < ui_x + ui_padding_horizontal + ui_size && ui_mouse_y > ui_y + ui_padding_horizontal && ui_mouse_y < ui_y + ui_padding_horizontal + ui_size) or (ui_mouse_x > ui_x + ui_padding_horizontal + ui_size && ui_mouse_x < ui_x + ui_padding_horizontal + ui_size + ui_padding_horizontal + string_width(string_hash_to_newline(ui_label)) && ui_mouse_y > ui_y + ui_padding_horizontal + ((ui_size * 0.5) - (string_height(string_hash_to_newline(ui_label)) * 0.5))&& ui_mouse_y < ui_y + ui_padding_horizontal + ((ui_size * 0.5) + (string_height(string_hash_to_newline(ui_label)) * 0.5))))){
          ui_shadow_alpha = 0.02;
          if(device_mouse_check_button_pressed(0, mb_left)){
            if(!ui_checked){
  ...
  if(ds_exists(argument[0], ds_type_map)){ 
    ...
    if(ui_type == ui_type_switch){  
      ...
      if(ui_enable){
        ...
        if(ui_active && ((ui_mouse_x > ui_x && ui_mouse_x < ui_x + ui_width && ui_mouse_y > ui_y && ui_mouse_y < ui_y + ui_height) or (ui_mouse_x > ui_x + ui_width && ui_mouse_x < ui_x + ui_width + ui_padding_horizontal + string_width(string_hash_to_newline(ui_label)) && ui_mouse_y > ui_y + ((ui_height * 0.5) - (string_height(string_hash_to_newline(ui_label)) * 0.5))&& ui_mouse_y < ui_y + ((ui_height * 0.5) + (string_height(string_hash_to_newline(ui_label)) * 0.5))) or (ui_focus && keyboard_action && keyboard_check_pressed(vk_enter)))){
          ui_alpha = 0.02;
          if(device_mouse_check_button_pressed(0, mb_left) or (ui_focus && keyboard_action && keyboard_check_pressed(vk_enter))){
            ui_checked = !ui_checked;
            ds_map_replace(argument[0], "ui_checked", ui_checked);
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        if(ui_shadow) draw_text_colour(ui_x + ui_width + ui_padding_horizontal, ui_y +(ui_height * 0.5) + 1, string_hash_to_newline(ui_label), ui_black, ui_black, ui_black, ui_black, 0.05);
        draw_text_colour(ui_x + ui_width + ui_padding_horizontal, ui_y +(ui_height * 0.5), string_hash_to_newline(ui_label), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
      else{
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        draw_text_colour(ui_x + ui_width + ui_padding_horizontal, ui_y +(ui_height * 0.5), string_hash_to_newline(ui_label), ui_grey, ui_grey, ui_grey, ui_grey, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
      if(ui_focus){
        if(ds_exists(ui_global_config, ds_type_map)){
          if(ds_map_find_value(ui_global_config, "debug_mode")){
            draw_set_alpha(0.25);
            draw_rectangle_colour(ui_x - 1, ui_y - 1, ui_x + ui_width + ui_padding_horizontal + string_width(string_hash_to_newline(ui_label)) + 2, ui_y + ui_height + 3, ui_blue_grey, ui_blue_grey, ui_blue_grey, ui_blue_grey, true);
            draw_set_alpha(1);
          }
        }
      }
  ...
  if(ds_exists(argument[0], ds_type_map)){
    ...
    if(ui_type == ui_type_select){
      ...
      if(ui_enable){
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        if(ui_shadow) draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical + (ui_height * 0.5) + 1, string_hash_to_newline(ui_text), ui_black, ui_black, ui_black, ui_black, 0.05);
        draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical + (ui_height * 0.5), string_hash_to_newline(ui_text), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        if(font_exists(ui_label_font)){
          draw_set_font(ui_label_font);
        }
        draw_set_valign(fa_top);
        var ui_label_top = (string_height(string_hash_to_newline("|")) * 0.85 + ui_padding_vertical);
        draw_text_transformed_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical - ui_label_top, string_hash_to_newline(ui_label), max(1 - ui_label_top / ((string_height(string_hash_to_newline("|")) * 0.85) + ui_padding_vertical), 0.85), max(1 - ui_label_top / (string_height(string_hash_to_newline("|")) * 0.85), 0.85), 0, ui_background_colour, ui_background_colour, ui_background_colour, ui_background_colour, 1);
        if(font_exists(ui_font)){
          draw_set_font(ui_font);
        }
        if(ui_open){
          ...
          for(var ui_i=0;ui_i<ds_list_size(ui_items);ui_i+=1){
            ...
            if(ui_shadow) draw_text_colour(ui_x + 16, ui_y + (ui_i * (ui_height + 20)) + (ui_height * 0.5) + 11 , string_hash_to_newline(ui_item_text), ui_black, ui_black, ui_black, ui_black, 0.05*ui_top);
            draw_text_colour(ui_x + 16, ui_y + (ui_i * (ui_height + 20)) + (ui_height * 0.5) + 10 , string_hash_to_newline(ui_item_text), ui_background_colour, ui_background_colour, ui_background_colour, ui_background_colour, ui_top);
          }
          draw_set_valign(fa_top);
        }
        else{
        ...
        draw_set_halign(fa_left);
        draw_set_valign(fa_middle);
        draw_text_colour(ui_x + ui_padding_horizontal, ui_y + ui_padding_vertical + (ui_height * 0.5), string_hash_to_newline(ui_text), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), ui_colour_lighter(ui_grey), 1);
        if(font_exists(ui_label_font)){
          draw_set_font(ui_label_font);
        }
        draw_set_valign(fa_top);
    ...
    if(ui_type == ui_type_range){
      ...
      if(ui_enable){
        ...
        if(ui_clicked or ui_top > 0){
          draw_set_alpha(ui_top);
          draw_circle_colour(ui_x + ui_padding_horizontal + (ui_height * 0.5) - 1 + ((ui_width - (ui_height))*(ui_value / ui_rangesize)), ui_y + (ui_padding_vertical + (ui_height * 0.5) - (ui_height * 0.45) - 20) * ui_top, ((string_width(string_hash_to_newline(string(ui_rangesize))) * 0.5) + 4) * ui_top, ui_foreground_colour, ui_foreground_colour, false);
          if(ui_top > 0.9){
            var tx1 = ui_x + ui_padding_horizontal + (ui_height * 0.5) + ((ui_width - (ui_height))*(ui_value / ui_rangesize)) - (string_width(string_hash_to_newline(string(ui_rangesize))) * 0.5);
            var ty1 = ui_y + ui_padding_vertical + (((ui_height * 0.5) - (ui_height * 0.45) - (string_width(string_hash_to_newline(string(ui_rangesize))) * 0.5))*ui_top);
            var tx2 = ui_x + ui_padding_horizontal + (ui_height * 0.5) + ((ui_width - (ui_height))*(ui_value / ui_rangesize)) + (string_width(string_hash_to_newline(string(ui_rangesize))) * 0.5);
            var ty2 = ui_y + ui_padding_vertical + (((ui_height * 0.5) - (ui_height * 0.45) - (string_width(string_hash_to_newline(string(ui_rangesize))) * 0.5))*ui_top);
          ...
          if(ui_shadow) draw_text_transformed_colour(ui_x + ui_padding_horizontal + (ui_height * 0.5) + ((ui_width - (ui_height))*(ui_value / ui_rangesize)), ui_y + ui_padding_vertical + (ui_height * 0.5) - (ui_height * 0.45) - 28, string_hash_to_newline(string(ui_value)), ui_top, ui_top, 0, ui_inner_colour, ui_inner_colour, ui_inner_colour, ui_inner_colour, ui_top);
          draw_text_transformed_colour(ui_x + ui_padding_horizontal + (ui_height * 0.5) + ((ui_width - (ui_height))*(ui_value / ui_rangesize)), ui_y + ui_padding_vertical + (ui_height * 0.5) - (ui_height * 0.45) - 28, string_hash_to_newline(string(ui_value)), ui_top, ui_top, 0, ui_inner_colour, ui_inner_colour, ui_inner_colour, ui_inner_colour, ui_top);
          draw_set_halign(fa_left);
    ...
    if(ui_type == ui_type_tab){
      ...
      if(ui_enable){
        ...
        for(var ui_i = 0; ui_i < ds_list_size(ui_items); ui_i += 1){
          ...
          if(ui_shadow) draw_text_colour(ui_x + (ui_item_width * ui_i) + (ui_item_width * 0.5), ui_y + (ui_height * 0.5) + 1, string_hash_to_newline(ds_map_find_value(ui_tab_item, "ui_tab_name")), ui_black, ui_black, ui_black, ui_black, 0.05);
          draw_text_colour(ui_x + (ui_item_width * ui_i) + (ui_item_width * 0.5), ui_y + (ui_height * 0.5), string_hash_to_newline(ds_map_find_value(ui_tab_item, "ui_tab_name")), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1); 
        }
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
        ...
        for(var ui_i = 0; ui_i < ds_list_size(ui_items); ui_i += 1){
          var ui_tab_item =  ds_list_find_value(ui_items, ui_i);
          draw_text_colour(ui_x + (ui_item_width * ui_i) + (ui_item_width * 0.5), ui_y + (ui_height * 0.5), string_hash_to_newline(ds_map_find_value(ui_tab_item, "ui_tab_name")), ui_grey, ui_grey, ui_grey, ui_grey, 1); 
        }
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
      }
...
if(ds_exists(ui_keyboard, ds_type_map)){
  ...
  if(ui_show or ui_top > 0){
    ...
    for(var ui_i = 0; ui_i < 11; ui_i += 1){
      if(ui_i < 10){
        if(ui_shadow){draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (0 * ui_block_height) + ui_add_effect + (ui_block_height / 2) + 1, string_hash_to_newline(ds_list_find_value(ui_char_list[0], ui_i)), ui_black, ui_black, ui_black, ui_black, 0.2);}
        draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (0 * ui_block_height) + ui_add_effect + (ui_block_height / 2), string_hash_to_newline(ds_list_find_value(ui_char_list[0], ui_i)), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        if(!ui_fn){draw_text_transformed_colour(ui_i * ui_block_width + (ui_block_width / 2) + string_width(string_hash_to_newline("X")), ui_y + (ui_block_height / 2) + (ui_height - (ui_height * ui_top)) - 16, string_hash_to_newline(ds_list_find_value(ui_char_list[5], ui_i)), 0.6, 0.6, 0, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);}
      }
      else{
        if(ui_shadow){
          draw_set_alpha(0.2);
    ...
    if(ui_fn){
      for(var ui_i = 0; ui_i < 11; ui_i += 1){
         if(ui_i < 10){
          if(ui_shadow){draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (1 * ui_block_height) + ui_add_effect + (ui_block_height / 2) +  1, string_hash_to_newline(string_replace(ds_list_find_value(ui_char_list[1], ui_i), "#", "\\#")), ui_black, ui_black, ui_black, ui_black, 0.2);}
          draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (1 * ui_block_height) + ui_add_effect + (ui_block_height / 2), string_hash_to_newline(string_replace(ds_list_find_value(ui_char_list[1], ui_i), "#", "\\#")), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        }
        else{
          if(ui_shadow){
            draw_set_alpha(0.2);
      ...
      for(var ui_i = 0; ui_i < 10; ui_i += 1){
        if(ui_i < 9){
          if(ui_shadow){draw_text_colour(ui_i * ui_block_width + (ui_block_width), ui_y + (1 * ui_block_height) + ui_add_effect + (ui_block_height / 2) +  1, string_hash_to_newline(ds_list_find_value(ui_char_list[1], ui_i)), ui_black, ui_black, ui_black, ui_black, 0.2);}
          draw_text_colour(ui_i * ui_block_width + (ui_block_width), ui_y + (1 * ui_block_height) + ui_add_effect + (ui_block_height / 2), string_hash_to_newline(ds_list_find_value(ui_char_list[1], ui_i)), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
        }
        else{
          if(ui_shadow){
            draw_set_alpha(0.2);
    ...
    if(ui_fn){
      for(var ui_i = 0; ui_i < 11; ui_i += 1){
        if(ui_shadow){draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (2 * ui_block_height) + ui_add_effect + (ui_block_height / 2) + 1, string_hash_to_newline(ds_list_find_value(ui_char_list[2], ui_i)), ui_black, ui_black, ui_black, ui_black, 0.2);}
        draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (2 * ui_block_height) + ui_add_effect + (ui_block_height / 2), string_hash_to_newline(ds_list_find_value(ui_char_list[2], ui_i)), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
      }
    }
    else{
      for(var ui_i = 0; ui_i < 11; ui_i += 1){
    ...
    for(var ui_i = 0; ui_i < 2; ui_i += 1){
      if(ui_shadow){draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (3 * ui_block_height) + ui_add_effect + (ui_block_height / 2) + 1, string_hash_to_newline(ds_list_find_value(ui_char_list[3], ui_i)), ui_black, ui_black, ui_black, ui_black, 0.2);}
      draw_text_colour(ui_i * ui_block_width + (ui_block_width / 2), ui_y + (3 * ui_block_height) + ui_add_effect + (ui_block_height / 2), string_hash_to_newline(ds_list_find_value(ui_char_list[3], ui_i)), ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, ui_foreground_colour, 1);
    }
